          ...
          <div>
            ...
            <div className="mb-6 flex">
              <input
                ...
                className="w-full px-3 py-2 rounded-l bg-gray-700 text-white focus:outline-none focus:bg-gray-600 flex-1"
              />
              <button className="bg-gray-700 rounded-r px-2"
